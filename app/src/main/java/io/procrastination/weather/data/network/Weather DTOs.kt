...
constructor(@Expose @SerializedName("id") val id : Int,
...
constructor(@Expose @SerializedName("lon") val longitude : Double,
...
constructor(@Expose @SerializedName("temp") val temp : Double,
...
constructor(@Expose @SerializedName("speed") val speed : Float,
...
constructor(@Expose @SerializedName("message") val message : Float,
            @Expose @SerializedName("country") val country : String?)//TODO: incomplete
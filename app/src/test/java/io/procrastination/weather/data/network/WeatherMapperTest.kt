...
class WeatherMapperTest {
    ...
    val iconsUrl = "http://openweathermap.org/img/w/"
    ...
    fun testConvertion() {
        ...
        val testSubject = WeatherMapper(iconsUrl).toModel(sampleAsJson)
        val groundTruth = WeatherInfo("Clear", 285, 5, 6, Date(1485792967L * 1000), LocationInfo(35.02,139.01, "Tawarano", "JP"), "http://openweathermap.org/img/w/01n.png")
